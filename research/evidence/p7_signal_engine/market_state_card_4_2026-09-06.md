# DK1 Market State Card 4 (no_trade)
...
- Card ID: P7-DEV-04
- Delivery hour (UTC): 2023-04-08 06:00:00+00:00
- Delivery hour (local): 2023-04-08 08:00:00+02:00
- Decision cutoff (UTC): 2023-04-08 06:00:00+00:00  (last pre-delivery snapshot, D025)
- Data version: P3 target + P4.2 revision, git-tracked evidence

## Information snapshot (decision-eligible only)

- Day-ahead price (EUR/MWh): 130.8
- Wind revision 5h->1h (MWh): -177.2
- 5h wind forecast (MWh): 706.5  (in the low-wind blind spot)
- Known residual load proxy (MWh): 1375
- H2 view: none   H1 view: none

## Market view

- Directional view: NO TRADE
- Confidence: n/a
- Primary driver: no eligible input crosses its threshold, or an input is missing
...
- Actual balancing price (EUR/MWh): 219.9
- Actual spread (EUR/MWh): 89.12
- Realized label: UP
