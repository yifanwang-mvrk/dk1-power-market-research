...
- Card ID: P7-DEV-01
- Delivery hour (UTC): 2023-04-19 11:00:00+00:00
- Delivery hour (local): 2023-04-19 13:00:00+02:00
- Decision cutoff (UTC): 2023-04-19 11:00:00+00:00  (last pre-delivery snapshot, D025)
- Data version: P3 target + P4.2 revision, git-tracked evidence

## Information snapshot (decision-eligible only)

- Day-ahead price (EUR/MWh): 5.29
- Wind revision 5h->1h (MWh): 476.7
- 5h wind forecast (MWh): 1904  (wind not low)
- Known residual load proxy (MWh): -624.7
...
- Actual balancing price (EUR/MWh): -15
- Actual spread (EUR/MWh): -20.29
- Realized label: DOWN
